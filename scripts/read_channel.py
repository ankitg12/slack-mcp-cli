...
def run(channel_id: str, limit: int, oldest: str | None, latest: str | None, as_json: bool, html_path: str | None) -> None:
    ...
    raw_text = call_tool("slack_read_channel", args)
...
def main() -> None:
    ...
    run(args.channel_id, args.limit, args.oldest, args.latest, args.json, args.html)
